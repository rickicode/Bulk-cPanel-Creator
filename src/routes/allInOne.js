...
router.post('/start', (req, res) => {
    const { whm, cloudflare, wpPassword, masterCloneDomain, domains, createAdsTxt, adsTxtContent, cloneMasterDomain } = req.body;
    ...
    startAllInOneProcess(processId, { whm, cloudflare, ssh, wpPassword, masterCloneDomain, domains, createAdsTxt, adsTxtContent, cloneMasterDomain }, req.processStateManager);
